...
let UsersService = class UsersService {
    ...
    findOneAll(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersRepository.findOneOrFail({ id_user: id });
        });
    }
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    findUsersWithPresence() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersRepository.query('SELECT DISTINCT `users`.`id_user`,`users`.`name`, `users`.`surname` FROM `users`, `presence` WHERE `users`.`id_user` = `presence`.`id_user` AND `users`.`status` = 1 ORDER BY `users`.`id_user` ASC');
        });
    }
    addToArchive(idArray) {
        return __awaiter(this, void 0, void 0, function* () {
